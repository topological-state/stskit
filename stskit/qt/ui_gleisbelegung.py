...
class Ui_GleisbelegungWindow(object):
    def setupUi(self, GleisbelegungWindow):
        ...
        self.verticalLayout_2.addWidget(self.beschriftung_table)
    ...
    def retranslateUi(self, GleisbelegungWindow):
        ...
        self.zuege_group.setTitle(_translate("GleisbelegungWindow", "Züge"))
        self.kategorien_label.setText(_translate("GleisbelegungWindow", "&Kategorien"))
        ...
        item.setText(_translate("GleisbelegungWindow", "Express"))
        item = self.kategorien_list.item(1)
        item.setText(_translate("GleisbelegungWindow", "Fernverkehr"))
        item = self.kategorien_list.item(2)
        item.setText(_translate("GleisbelegungWindow", "Nahverkehr"))
        item = self.kategorien_list.item(3)
        item.setText(_translate("GleisbelegungWindow", "S-Bahn"))
        item = self.kategorien_list.item(4)
        item.setText(_translate("GleisbelegungWindow", "Güterzug"))
        item = self.kategorien_list.item(5)
        item.setText(_translate("GleisbelegungWindow", "Sonderzug"))
        item = self.kategorien_list.item(6)
        item.setText(_translate("GleisbelegungWindow", "Dienstzug"))
        item = self.kategorien_list.item(7)
        item.setText(_translate("GleisbelegungWindow", "Rangierfahrt"))
        self.kategorien_list.setSortingEnabled(__sortingEnabled)
        self.beschriftung_label.setText(_translate("GleisbelegungWindow", "&Beschriftung"))
        item = self.beschriftung_table.verticalHeaderItem(0)
        item.setText(_translate("GleisbelegungWindow", "Gleis"))
        item = self.beschriftung_table.verticalHeaderItem(1)
        item.setText(_translate("GleisbelegungWindow", "Zug"))
        item = self.beschriftung_table.verticalHeaderItem(2)
        item.setText(_translate("GleisbelegungWindow", "Nummer"))
        item = self.beschriftung_table.verticalHeaderItem(3)
        item.setText(_translate("GleisbelegungWindow", "Richtung"))
        item = self.beschriftung_table.verticalHeaderItem(4)
        item.setText(_translate("GleisbelegungWindow", "Zeit"))
        item = self.beschriftung_table.verticalHeaderItem(5)
        item.setText(_translate("GleisbelegungWindow", "Verspätung"))
        item = self.beschriftung_table.horizontalHeaderItem(0)
        item.setText(_translate("GleisbelegungWindow", "Ankunft"))
        item = self.beschriftung_table.horizontalHeaderItem(1)
        item.setText(_translate("GleisbelegungWindow", "Abfahrt"))
