...
class Ui_GleisbelegungWindow(object):
    def setupUi(self, GleisbelegungWindow):
        ...
        self.actionBetriebshaltEinfuegen = QAction(GleisbelegungWindow)
        self.actionBetriebshaltEinfuegen.setObjectName(u"actionBetriebshaltEinfuegen")
        self.actionVorzeitigeAbfahrt = QAction(GleisbelegungWindow)
...
#endif // QT_CONFIG(shortcut)
        self.actionBetriebshaltEinfuegen.setText(QCoreApplication.translate("GleisbelegungWindow", u"Betriebshalt", None))
#if QT_CONFIG(tooltip)
        self.actionBetriebshaltEinfuegen.setToolTip(QCoreApplication.translate("GleisbelegungWindow", u"Betriebshalt einf\u00fcgen (H)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionBetriebshaltEinfuegen.setShortcut(QCoreApplication.translate("GleisbelegungWindow", u"H", None))
#endif // QT_CONFIG(shortcut)
        self.actionVorzeitigeAbfahrt.setText(QCoreApplication.translate("GleisbelegungWindow", u"Vorzeitige Abfahrt", None))
#if QT_CONFIG(tooltip)
        self.actionVorzeitigeAbfahrt.setToolTip(QCoreApplication.translate("GleisbelegungWindow", u"Vorzeitige Abfahrt vermerken (A)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionVorzeitigeAbfahrt.setShortcut(QCoreApplication.translate("GleisbelegungWindow", u"A", None))
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionUnbelegteGleise.setToolTip(QCoreApplication.translate("GleisbelegungWindow", u"Unbelegte Gleise anzeigen (U)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionUnbelegteGleise.setShortcut(QCoreApplication.translate("GleisbelegungWindow", u"U", None))
#endif // QT_CONFIG(shortcut)
