...
class Ui_GleisbelegungWindow(object):
    def setupUi(self, GleisbelegungWindow):
        ...
        icon11 = QIcon()
        icon11.addFile(u":/lucide/lucide/columns-3.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/lucide/lucide/git-compare-arrows.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionKreuzung.setIcon(icon12)
