...
class Ui_BildfahrplanWindow(object):
    def setupUi(self, BildfahrplanWindow):
        ...
        self.zuege_group = QtWidgets.QGroupBox(self.settings_page)
        self.zuege_group.setObjectName("zuege_group")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.zuege_group)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.zuege_layout = QtWidgets.QVBoxLayout()
        self.zuege_layout.setObjectName("zuege_layout")
        self.kategorien_label = QtWidgets.QLabel(self.zuege_group)
        self.kategorien_label.setObjectName("kategorien_label")
        self.zuege_layout.addWidget(self.kategorien_label)
        self.kategorien_list = QtWidgets.QListWidget(self.zuege_group)
        self.kategorien_list.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.kategorien_list.sizePolicy().hasHeightForWidth())
        self.kategorien_list.setSizePolicy(sizePolicy)
        self.kategorien_list.setAlternatingRowColors(True)
        self.kategorien_list.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.kategorien_list.setObjectName("kategorien_list")
        item = QtWidgets.QListWidgetItem()
        self.kategorien_list.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.kategorien_list.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.kategorien_list.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.kategorien_list.addItem(item)
        self.zuege_layout.addWidget(self.kategorien_list)
        self.beschriftung_label = QtWidgets.QLabel(self.zuege_group)
        self.beschriftung_label.setObjectName("beschriftung_label")
        self.zuege_layout.addWidget(self.beschriftung_label)
        self.beschriftung_table = QtWidgets.QTableWidget(self.zuege_group)
        self.beschriftung_table.setEnabled(False)
        self.beschriftung_table.setAlternatingRowColors(True)
        self.beschriftung_table.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.beschriftung_table.setObjectName("beschriftung_table")
        self.beschriftung_table.setColumnCount(2)
        self.beschriftung_table.setRowCount(6)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.beschriftung_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        self.beschriftung_table.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(3, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(3, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(4, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(4, 1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(5, 0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Unchecked)
        self.beschriftung_table.setItem(5, 1, item)
        self.zuege_layout.addWidget(self.beschriftung_table)
        self.verticalLayout_7.addLayout(self.zuege_layout)
        self.horizontalLayout_2.addWidget(self.zuege_group)
        ...
        self.kategorien_label.setBuddy(self.kategorien_list)
        self.beschriftung_label.setBuddy(self.beschriftung_table)
    ...
    def retranslateUi(self, BildfahrplanWindow):
        ...
        self.zuege_group.setTitle(_translate("BildfahrplanWindow", "Züge"))
        self.kategorien_label.setText(_translate("BildfahrplanWindow", "&Kategorien"))
        __sortingEnabled = self.kategorien_list.isSortingEnabled()
        self.kategorien_list.setSortingEnabled(False)
        item = self.kategorien_list.item(0)
        item.setText(_translate("BildfahrplanWindow", "Express"))
        item = self.kategorien_list.item(1)
        item.setText(_translate("BildfahrplanWindow", "Fernverkehr"))
        item = self.kategorien_list.item(2)
        item.setText(_translate("BildfahrplanWindow", "Nahverkehr"))
        item = self.kategorien_list.item(3)
        item.setText(_translate("BildfahrplanWindow", "S-Bahn"))
        item = self.kategorien_list.item(4)
        item.setText(_translate("BildfahrplanWindow", "Güterzug"))
        item = self.kategorien_list.item(5)
        item.setText(_translate("BildfahrplanWindow", "Sonderzug"))
        item = self.kategorien_list.item(6)
        item.setText(_translate("BildfahrplanWindow", "Dienstzug"))
        item = self.kategorien_list.item(7)
        item.setText(_translate("BildfahrplanWindow", "Rangierfahrt"))
        self.kategorien_list.setSortingEnabled(__sortingEnabled)
        self.beschriftung_label.setText(_translate("BildfahrplanWindow", "&Beschriftung"))
        item = self.beschriftung_table.verticalHeaderItem(0)
        item.setText(_translate("BildfahrplanWindow", "Gleis"))
        item = self.beschriftung_table.verticalHeaderItem(1)
        item.setText(_translate("BildfahrplanWindow", "Zug"))
        item = self.beschriftung_table.verticalHeaderItem(2)
        item.setText(_translate("BildfahrplanWindow", "Nummer"))
        item = self.beschriftung_table.verticalHeaderItem(3)
        item.setText(_translate("BildfahrplanWindow", "Richtung"))
        item = self.beschriftung_table.verticalHeaderItem(4)
        item.setText(_translate("BildfahrplanWindow", "Zeit"))
        item = self.beschriftung_table.verticalHeaderItem(5)
        item.setText(_translate("BildfahrplanWindow", "Verspätung"))
        item = self.beschriftung_table.horizontalHeaderItem(0)
        item.setText(_translate("BildfahrplanWindow", "Ankunft"))
        item = self.beschriftung_table.horizontalHeaderItem(1)
        item.setText(_translate("BildfahrplanWindow", "Abfahrt"))
        __sortingEnabled = self.beschriftung_table.isSortingEnabled()
        self.beschriftung_table.setSortingEnabled(False)
        self.beschriftung_table.setSortingEnabled(__sortingEnabled)
