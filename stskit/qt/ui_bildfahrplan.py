...
class Ui_BildfahrplanWindow(object):
    def setupUi(self, BildfahrplanWindow):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/chain--2in-1out.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionKreuzung.setIcon(icon10)
        self.actionZugfolge = QAction(BildfahrplanWindow)
        self.actionZugfolge.setObjectName(u"actionZugfolge")
        icon11 = QIcon()
        icon11.addFile(u":/chain--1in-1out.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionZugfolge.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/clock--return.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionVerspaetungLoeschen.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/clock--cross.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionVorzeitigeAbfahrt.setIcon(icon13)
        ...
        self.toolBar.addAction(self.actionVerspaetungLoeschen)
        self.toolBar.addSeparator()
        ...
        self.toolBar.addAction(self.actionZugfolge)
