...
class Ui_BildfahrplanWindow(object):
    def setupUi(self, BildfahrplanWindow):
        ...
        self.actionKreuzung = QAction(BildfahrplanWindow)
        self.actionKreuzung.setObjectName(u"actionKreuzung")
        self.actionZugfolge = QAction(BildfahrplanWindow)
        self.actionZugfolge.setObjectName(u"actionZugfolge")
        self.actionVerspaetungLoeschen = QAction(BildfahrplanWindow)
        self.actionVerspaetungLoeschen.setObjectName(u"actionVerspaetungLoeschen")
        self.actionVorzeitigeAbfahrt = QAction(BildfahrplanWindow)
        self.actionVorzeitigeAbfahrt.setObjectName(u"actionVorzeitigeAbfahrt")
        ...
        self.toolBar.addAction(self.actionVorzeitigeAbfahrt)
...
#if QT_CONFIG(tooltip)
        self.actionPlusEins.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Versp\u00e4tung +1 Minute auf ausgew\u00e4hltem Segment (+)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionMinusEins.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Versp\u00e4tung -1 Minute auf ausgew\u00e4hltem Segment (-)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        self.actionFix.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Versp\u00e4tung auf ausgew\u00e4hltem Segment bearbeiten (V)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.actionAnkunftAbwarten.setText(QCoreApplication.translate("BildfahrplanWindow", u"Ankunft abwarten", None))
#if QT_CONFIG(tooltip)
        self.actionAnkunftAbwarten.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Anschluss: Ankunft von zweitem gew\u00e4hlten Zug abwarten (N)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionAnkunftAbwarten.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"N", None))
#endif // QT_CONFIG(shortcut)
        self.actionAbfahrtAbwarten.setText(QCoreApplication.translate("BildfahrplanWindow", u"Abfahrt abwarten", None))
#if QT_CONFIG(tooltip)
        self.actionAbfahrtAbwarten.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"\u00dcberholung: Abfahrt von zweitem gew\u00e4hlten Zug abwarten (B)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionAbfahrtAbwarten.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"B", None))
#endif // QT_CONFIG(shortcut)
        self.actionBetriebshaltEinfuegen.setText(QCoreApplication.translate("BildfahrplanWindow", u"Betriebshalt", None))
#if QT_CONFIG(tooltip)
        self.actionBetriebshaltEinfuegen.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Betriebshalt einf\u00fcgen (H)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionBetriebshaltEinfuegen.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"H", None))
#endif // QT_CONFIG(shortcut)
        self.actionActionBetriebshaltLoeschen.setText(QCoreApplication.translate("BildfahrplanWindow", u"Betriebshalt l\u00f6schen", None))
#if QT_CONFIG(tooltip)
        self.actionActionBetriebshaltLoeschen.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Betriebshalt l\u00f6schen (Shift+H)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionActionBetriebshaltLoeschen.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"Shift+H", None))
#endif // QT_CONFIG(shortcut)
        self.actionKreuzung.setText(QCoreApplication.translate("BildfahrplanWindow", u"Kreuzung", None))
#if QT_CONFIG(tooltip)
        self.actionKreuzung.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Kreuzung: Ankunft beider Z\u00fcge abwarten (K)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionKreuzung.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"K", None))
#endif // QT_CONFIG(shortcut)
        self.actionZugfolge.setText(QCoreApplication.translate("BildfahrplanWindow", u"Zugfolge", None))
#if QT_CONFIG(tooltip)
        self.actionZugfolge.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Zugfolge: Ankunft nach zweitem gew\u00e4hlten Zug (F)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionZugfolge.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"F", None))
#endif // QT_CONFIG(shortcut)
        self.actionVerspaetungLoeschen.setText(QCoreApplication.translate("BildfahrplanWindow", u"Versp\u00e4tung zur\u00fccksetzen", None))
#if QT_CONFIG(shortcut)
        self.actionVerspaetungLoeschen.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"Shift+V", None))
#endif // QT_CONFIG(shortcut)
        self.actionVorzeitigeAbfahrt.setText(QCoreApplication.translate("BildfahrplanWindow", u"Vorzeitige Abfahrt", None))
#if QT_CONFIG(tooltip)
        self.actionVorzeitigeAbfahrt.setToolTip(QCoreApplication.translate("BildfahrplanWindow", u"Vorzeitige Abfahrt vermerken (A)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionVorzeitigeAbfahrt.setShortcut(QCoreApplication.translate("BildfahrplanWindow", u"A", None))
#endif // QT_CONFIG(shortcut)
