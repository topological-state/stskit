...
class Ui_BildfahrplanWindow(object):
    def setupUi(self, BildfahrplanWindow):
        ...
        icon8 = QIcon()
        icon8.addFile(u":/lucide/lucide/git-commit-vertical.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.actionActionBetriebshaltLoeschen.setIcon(icon5)
        self.actionKreuzung = QAction(BildfahrplanWindow)
        self.actionKreuzung.setObjectName(u"actionKreuzung")
        icon9 = QIcon()
        icon9.addFile(u":/lucide/lucide/git-compare-arrows.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionKreuzung.setIcon(icon9)
        self.actionZugfolge = QAction(BildfahrplanWindow)
        self.actionZugfolge.setObjectName(u"actionZugfolge")
        icon10 = QIcon()
        icon10.addFile(u":/lucide/lucide/git-pull-request-flip.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionZugfolge.setIcon(icon10)
        ...
        self.actionVerspaetungLoeschen.setIcon(icon5)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/lucide/lucide/wand.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionVorzeitigeAbfahrt.setIcon(icon11)
