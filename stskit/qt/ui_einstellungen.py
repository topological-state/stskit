...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.strecken_auswahl_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Station in Strecke \u00fcbernehmen", None))
#endif // QT_CONFIG(tooltip)
        self.strecken_auswahl_button.setText(QCoreApplication.translate("EinstellungenWindow", u"\u2b05\ufe0f", None))
#if QT_CONFIG(tooltip)
        self.strecken_abwahl_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Station aus Strecke entfernen", None))
#endif // QT_CONFIG(tooltip)
        self.strecken_abwahl_button.setText(QCoreApplication.translate("EinstellungenWindow", u"\u27a1\ufe0f", None))
#if QT_CONFIG(tooltip)
        self.strecken_hoch_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Station nach vorne schieben", None))
#endif // QT_CONFIG(tooltip)
        self.strecken_hoch_button.setText(QCoreApplication.translate("EinstellungenWindow", u"\u2b06\ufe0f", None))
#if QT_CONFIG(tooltip)
        self.strecken_runter_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Station nach hinten schieben", None))
#endif // QT_CONFIG(tooltip)
        self.strecken_runter_button.setText(QCoreApplication.translate("EinstellungenWindow", u"\u2b07\ufe0f", None))
#if QT_CONFIG(tooltip)
        self.strecken_interpolieren_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Strecke zwischen Anfangs- und Endstation aus Netzplan erstellen", None))
#endif // QT_CONFIG(tooltip)
        self.strecken_interpolieren_button.setText(QCoreApplication.translate("EinstellungenWindow", u"Interpolieren", None))
#if QT_CONFIG(tooltip)
        self.strecken_ordnen_button.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"Stationen nach Entfernung im Netzplan anordnen", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.strecken_abwahl_list.setToolTip(QCoreApplication.translate("EinstellungenWindow", u"\u00fcbrige Stationen", None))
#endif // QT_CONFIG(tooltip)
