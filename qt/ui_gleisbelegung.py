...
class Ui_GleisbelegungWindow(object):
    def setupUi(self, GleisbelegungWindow):
        ...
        self.treeWidget = QtWidgets.QTreeWidget(self.settings_page)
    ...
    def retranslateUi(self, GleisbelegungWindow):
        ...
        self.treeWidget.headerItem().setText(0, _translate("GleisbelegungWindow", "Gleis"))
        self.treeWidget.headerItem().setText(1, _translate("GleisbelegungWindow", "Konfliktgruppe"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("GleisbelegungWindow", "Anschlüsse"))
        self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("GleisbelegungWindow", "EA"))
        self.treeWidget.topLevelItem(0).child(0).child(0).setText(0, _translate("GleisbelegungWindow", "EA 1"))
        self.treeWidget.topLevelItem(0).child(0).child(0).setText(1, _translate("GleisbelegungWindow", "EA"))
        self.treeWidget.topLevelItem(0).child(0).child(1).setText(0, _translate("GleisbelegungWindow", "EA 2"))
        self.treeWidget.topLevelItem(0).child(0).child(1).setText(1, _translate("GleisbelegungWindow", "EA"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("GleisbelegungWindow", "Bahnhöfe"))
        self.treeWidget.topLevelItem(1).child(0).setText(0, _translate("GleisbelegungWindow", "A"))
        self.treeWidget.topLevelItem(1).child(0).child(0).setText(0, _translate("GleisbelegungWindow", "A 1"))
        self.treeWidget.topLevelItem(1).child(0).child(0).setText(1, _translate("GleisbelegungWindow", "A 1"))
        self.treeWidget.topLevelItem(1).child(0).child(1).setText(0, _translate("GleisbelegungWindow", "A 1 kurz"))
        self.treeWidget.topLevelItem(1).child(0).child(1).setText(1, _translate("GleisbelegungWindow", "A 1"))
        self.treeWidget.topLevelItem(1).child(0).child(2).setText(0, _translate("GleisbelegungWindow", "A 2"))
        self.treeWidget.topLevelItem(1).child(0).child(2).setText(1, _translate("GleisbelegungWindow", "A 2"))
        self.treeWidget.topLevelItem(1).child(1).setText(0, _translate("GleisbelegungWindow", "B"))
        self.treeWidget.topLevelItem(1).child(1).child(0).setText(0, _translate("GleisbelegungWindow", "B 1"))
        self.treeWidget.topLevelItem(1).child(1).child(0).setText(1, _translate("GleisbelegungWindow", "B1"))
        self.treeWidget.topLevelItem(1).child(1).child(1).setText(0, _translate("GleisbelegungWindow", "B 2"))
        self.treeWidget.topLevelItem(1).child(1).child(1).setText(1, _translate("GleisbelegungWindow", "B2"))
        self.treeWidget.topLevelItem(1).child(1).child(2).setText(0, _translate("GleisbelegungWindow", "B 3a"))
        self.treeWidget.topLevelItem(1).child(1).child(2).setText(1, _translate("GleisbelegungWindow", "B3"))
        self.treeWidget.topLevelItem(1).child(1).child(3).setText(0, _translate("GleisbelegungWindow", "B 3b"))
        self.treeWidget.topLevelItem(1).child(1).child(3).setText(1, _translate("GleisbelegungWindow", "B3"))
